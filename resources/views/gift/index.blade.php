    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="page-title">List of Gift's</h3>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($gifts as $gift)
                                            <tr class="text-center">
                                                ...
                                                <td>{{ $gift->name }}</td>
                                                <td>{{ $gift->price }}</td>
                                                <td><img src="{{ asset($gift->image) }}" style="width: 50px;height: 50px;" alt="No Image"></td>
                                                <td style="align-content: center !important;">
                                                    <div class="status-toggle">
                                                        <input type="checkbox" id="status_{{ $gift->id }}"
                                                            class="check status-switch" data-notify-id="{{ $gift->id }}"
                                                            data-status="{{ $gift->is_active }}"
                                                            {{ $gift->is_active == 1 ? 'checked' : '' }} />
                                                        <label for="status_{{ $gift->id }}"
                                                            class="checktoggle">checkbox</label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <button class="btn btn-primary"
                                                        onclick="editNotification({{ $gift->id }})">Edit</button>
                                                    <button class="btn btn-primary"
                                                        onclick="deleteNotification({{ $gift->id }})">Delete</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
